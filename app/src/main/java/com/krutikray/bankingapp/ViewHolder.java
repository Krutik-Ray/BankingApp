...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    private com.krutikray.bankingapp.ViewHolder.ClickListener mClickListener;
    public interface  ClickListener{
        void onItemClick(View view, int position);
    }

    public void setOnClickListener(com.krutikray.bankingapp.ViewHolder.ClickListener clickListener){
